...
if __name__ == '__main__':
    ...
    with open(fname, 'r') as f:
        ...
        minimum_hashtags = min(hashtag_count.keys())
        count_3_or_more = sum(count for tag_count, count in hashtag_count.items() if tag_count >= 3)
        count_6_or_above = sum(count for tag_count, count in hashtag_count.items() if tag_count >= 6)

        print("Count of tweets with 6 or more hashtags:", count_6_or_above)

        print("Count of tweets with 3 hashtags or more:", count_3_or_more)

        print("Minimum number of hashtags in a tweet:", minimum_hashtags)
